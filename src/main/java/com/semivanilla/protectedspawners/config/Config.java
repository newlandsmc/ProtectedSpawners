...
public class Config {
    ...
    public static String blockBreakMessage = "<red>You can't break this block, to break it do /breakconfirm and break this block";
    public static String commandTimeOutMessage = "<red>Timed out, rerun /breakconfirm to break protected blocks";
